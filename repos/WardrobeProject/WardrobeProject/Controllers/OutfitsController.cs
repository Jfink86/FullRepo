...
namespace WardrobeProject.Controllers
{
    public class OutfitsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OutfitID,BottomID,TopID,ShoeID,AccessoryID,Name,Occasion")] Outfit outfit)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OutfitID,BottomID,TopID,ShoeID,AccessoryID,Name,Occasion")] Outfit outfit)
        {
            if (ModelState.IsValid)
            {
