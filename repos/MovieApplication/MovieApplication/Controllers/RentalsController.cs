...
namespace MovieApplication.Controllers
{
    public class RentalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "RentalsID,CustomerID,MovieID,DateRented")] Rental rental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RentalsID,CustomerID,MovieID,DateRented")] Rental rental)
        {
            if (ModelState.IsValid)
            {
